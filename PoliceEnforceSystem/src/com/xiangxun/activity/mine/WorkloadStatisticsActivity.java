...
public class WorkloadStatisticsActivity extends BaseActivity implements OnClickListener {
	private TextView viocount, enforcecount, accidentcount, libcount, dutycount, zhifacount, warnackcount, updateviocount;
	private RelativeLayout viodata, enforcedata, accidentdata, libdata, dutydata, zhifadata, warnackdata, updateviodata;
	...
	public void initView() {
		...
		updateviocount = (TextView) findViewById(R.id.updateviocount);
		updateviodata = (RelativeLayout) findViewById(R.id.updateviodata);
	}
	...
	public void initListener() {
		...
		updateviodata.setOnClickListener(this);
	}
	...
	public void initData() {
		...
		warnackcount.setText(DBManager.getInstance().QueryUpWarnMessageCount() + "");
		updateviocount.setText(DBManager.getInstance().QueryUpUpdateVioCount() + "");
	}
	...
	public void onClick(View arg0) {
		...
		case R.id.warnackdata:
			...
			break;
		case R.id.updateviodata:
			Intent updatevio = new Intent(WorkloadStatisticsActivity.this, UpdateVioListActivity.class);
			startActivity(updatevio);
			break;
		default:
			break;
		}
