...
public class SystemCfg {
	...
	public static String getServerIP(Context context) {
		...
		if (DEBUGURL)
			...
			return mysp.getString("serverip", "127.0.0.1");
	}
	...
	public static String getServerPort(Context context) {
		...
		if (DEBUGURL)
			...
			return mysp.getString("serverport", "8802");
	}
	...
	public static void setUpdateName(Context context,String dep) {
		init(context);
		mysp.edit().putString("updatename", dep).commit();
	}
	public static String getUpdateName(Context context) {
		init(context);
		return mysp.getString("updatename", "");
	}
	public static void setUpdateCode(Context context,String dep) {
		init(context);
		mysp.edit().putString("updatecode", dep).commit();
	}
	public static String getUpdateCode(Context context) {
		init(context);
		return mysp.getString("updatecode", "");
	}
	/**
	 * 电话
	 */
...
//	}
	...
	public static String getWarnCross(Context context) {
		init(context);
		if (DEBUGURL)
			return mysp.getString("warncross", "null");
		else
		return mysp.getString("warncross", "无");
	}

	public static void setWarnType(Context context,String type) {
		init(context);
		mysp.edit().putString("warntype", type).commit();
	}

	public static String getWarnType(Context context) {
		init(context);
		return mysp.getString("warntype", "无");
	}

	public static void setWarnTypeCode(Context context,String type) {
		init(context);
		mysp.edit().putString("warntypecode", type).commit();
	}

	public static String getWarnTypeCode(Context context) {
		init(context);
		return mysp.getString("warntypecode", "无");
	}

	public static void setWarnDirect(Context context,String type) {
		init(context);
		mysp.edit().putString("warndirect", type).commit();
	}

	public static String getWarnDirect(Context context) {
		init(context);
		return mysp.getString("warndirect", "无");
	}

	public static void setWarnDirectCode(Context context,String type) {
		init(context);
		mysp.edit().putString("warndirectcode", type).commit();
	}

	public static String getWarnDirectCode(Context context) {
		init(context);
		return mysp.getString("warndirectcode", "无");
	}
	...
	public static void setRoadHistory(Context context,String roadname) {
		init(context);
		mysp.edit().putString("RoadHistory", roadname).commit();
	}

	public static String getRoadHistory(Context context) {
		init(context);
		return mysp.getString("RoadHistory", "");
	}

	public static void setVioHistory(Context context,String roadname) {
		init(context);
		mysp.edit().putString("VioHistory", roadname).commit();
	}

	public static String getVioHistory(Context context) {
		init(context);
		return mysp.getString("VioHistory", "");
	}

	public static void setIsSavePassword(Context context,boolean value) {
		init(context);
		mysp.edit().putBoolean("isSavePassword", value).commit();
	}


	public static boolean getIsSavePassword(Context context) {
		init(context);
		return mysp.getBoolean("isSavePassword", false);
	}
}
