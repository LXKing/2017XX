...
public class SendVioData implements IBaseSendData {
	...
	public boolean run(Object obj) {
		...
		if(vioData.disposetype == 1){
			...
			String data1[] = vioData.roaddirect.split("-");
			params.add(new BasicNameValuePair("lddm",data1[0]  != null ? data1[0] : "0000"));
			params.add(new BasicNameValuePair("roaddirect", ""));
			String data2[] = vioData.platetype.split("-");
			params.add(new BasicNameValuePair("platetype", data2[0]  != null ? data2[0] : "00"));
			params.add(new BasicNameValuePair("jtfs", data2[1]  != null ? data2[1] : ""));
		}
