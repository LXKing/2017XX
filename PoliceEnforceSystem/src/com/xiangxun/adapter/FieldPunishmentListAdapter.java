...
public class FieldPunishmentListAdapter extends BaseAdapter {
	private List<FieldPunishData> lists;
	private Context context;
	private XListView mListView;
	private int size = 0;

	public FieldPunishmentListAdapter(Context context, XListView mXListView) {
		this.context = context;
		this.mListView = mXListView;
	}

	public void setData(List<FieldPunishData> itemList) {
		if (itemList != null) {
			this.lists = itemList;
			size = itemList.size();
		}
