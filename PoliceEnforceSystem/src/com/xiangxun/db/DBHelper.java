...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		// 上传六合一违法
		db.execSQL("CREATE TABLE IF NOT EXISTS updatevio "
				+ "(_id INTEGER PRIMARY KEY, "
				+ "type TEXT, "+ "datetime TEXT, "
				+ "vio TEXT, " + "sn TEXT, "
				+ "isupfile NUMERIC)");
		// warnmessage
		db.execSQL("CREATE TABLE IF NOT EXISTS warnmessage "
				+ "(_id INTEGER PRIMARY KEY, " + "yjxh TEXT, "
				+ "data TEXT, " + "sign TEXT, " + "ack TEXT, " + "pic TEXT, "
				+ "vio TEXT, " + "datetime TEXT, "
				+ "step NUMERIC, " + "isupfile NUMERIC)");
	}
