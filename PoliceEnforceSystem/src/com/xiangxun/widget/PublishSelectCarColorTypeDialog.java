 ...
 */
public class PublishSelectCarColorTypeDialog extends Dialog {
	...
	public PublishSelectCarColorTypeDialog(Context context, List<Type> types, TextView finalStyle,String mTitle) {
	...
	public void setSelection(int position){
		...
		mTvFinalStyle.setText(type.name);
		mTvFinalStyle.setTag(type);
	}
	...
	public void setSelectCode(String str) {
		...
		int i;
		for (i = 0; i < len; i++) {
			if (types.get(i).getCode().equals(str)) {
				this.setSelection(i);
				break;
			}
		}
