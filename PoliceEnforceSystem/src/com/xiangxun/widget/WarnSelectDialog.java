 ...
 */
public class WarnSelectDialog extends Dialog {
	...
	private WarnSelectDialog dialog;

	public WarnSelectDialog(Context context, String[] roads, TextView finalStyle, String title) {
		...
		mLvPublishTypes.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if(carVioTypeClick != null){
					carVioTypeClick.vioTypeOnClick(dialog,  road);
				}
				dismiss();
			}
		});
