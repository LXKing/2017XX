 ...
 */
public class PublishSelectAffairsTypeDialog extends Dialog {
	...
	public PublishSelectAffairsTypeDialog(Context context, List<Type> types, TextView finalStyle,String mTitle) {
