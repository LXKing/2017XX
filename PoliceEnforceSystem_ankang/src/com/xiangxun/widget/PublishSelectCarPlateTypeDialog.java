 ...
 */
public class PublishSelectCarPlateTypeDialog extends Dialog {
	...
	public PublishSelectCarPlateTypeDialog(Context context, List<Type> types, TextView finalStyle,String mTitle) {
