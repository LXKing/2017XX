 ...
 * @ClassName: EnforcementMeasureDetailActivity.java
 * @Description: 行政強制措施详情页面
 * @author: HanGJ
 * @date: 2015-8-14 下午4:19:43
 */
public class EnforcementMeasureDetailActivity extends BaseActivity implements OnClickListener, OnPageChangeListener {
	...
	private TextView mTvAction;// 强制措施
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detail_enforcement_measure_layou);
		mContext = this;
		initView();
		initData();
		initListener();
	...
	public void initView() {
		...
		mTvAction = (TextView) findViewById(R.id.tv_vio_action);// 强制措施
	}
	...
	public void initData() {
		...
		mTvType.setText(bundle.getString("viotype"));
		...
		mTvAction.setText(bundle.getString("action"));
	...
	private boolean print() {
		if (mPrintService != null) {
			return mPrintService.print(mPrintService.formatContent(generateContent(), 10), PrintInfo.TITLE_TYPE_DETAINMENT);
		} else {
			return false;
		}
	...
	private String generateContent() {
		...
		content.append(resources.getString(R.string.bianhao) + mTvPublishCode.getText().toString() + "%end%");
		content.append(resources.getString(R.string.beichufaren) + mTvDriverName.getText().toString() + "%end%");
		content.append(resources.getString(R.string.phone) + "：" + mTvDriverPhone.getText().toString() + "%end%");
		content.append(resources.getString(R.string.driverId) + "%end%");
		content.append(mTvDriverCode.getText().toString() + "%end%");
		content.append(resources.getString(R.string.recordId) + mTvRecordCode.getText().toString() + "%end%");
		content.append(resources.getString(R.string.organization) + mTvLicenseOffice.getText().toString() + "  ");
		content.append(resources.getString(R.string.driveType) + mTvLicenseType.getText().toString() + "%end%");
		content.append(resources.getString(R.string.plateNum) + mTvCarPlateNum.getText().toString() + "%end%");
		content.append(resources.getString(R.string.plateType) + mTvCarPlateType.getText().toString() + "%end%");
//		content.append(resources.getString(R.string.organization) + mTvCarOffice.getText().toString() + "%end%");
		content.append(resources.getString(R.string.dangshiren));	// + mTvDriverName.getText().toString());
		content.append(resources.getString(R.string.yu) + Utils.ChangeTimeTochs(mTvDate.getText().toString()));
		...
		content.append(resources.getString(R.string.shishi) + mTvType.getText().toString());
