...
public class SettingActivity extends BaseFragmentActivity implements android.view.View.OnClickListener, SelectclearDateItemClick, SelectLawDateItemClick {
...
//				}
	...
	public void initListener() {
		...
		workRoadDialog.setSelectLawDateItemClick(this);
	...
	public void lawDateOnClick(int position) {
		...
		if (position == 0) {
			SystemCfg.setWorkRoad(this, getResources().getString(R.string.workroad_city));
		} else if (position == 1) {
			SystemCfg.setWorkRoad(this, getResources().getString(R.string.workroad_speed));
		}
	}
}
