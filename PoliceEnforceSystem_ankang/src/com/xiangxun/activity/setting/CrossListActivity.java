...
public class CrossListActivity extends BaseActivity {
			...
			switch (msg.what) {
				case ConstantStatus.SEARCH_CROSS_SUCCESS:
					...
					if (groupCross != null && groupCross.getCross_total() > 0) {
						String departmentName = SystemCfg.getDepartment(CrossListActivity.this);
						if (departmentName.contains("中队"))
							groupCross.setDepartment_name(SystemCfg.getParentDepartmentName(CrossListActivity.this));
						else
							groupCross.setDepartment_name(SystemCfg.getDepartment(CrossListActivity.this));
	...
	public void initListener() {
		...
		btnEnter.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				//保存预警卡口名称
				SystemCfg.setWarnCross(CrossListActivity.this, CrossNames);
...
//		InitCrossData();
		DcNetWorkUtils.searchWarnCross(CrossListActivity.this, mUIHandler);
	...
	private void loadWarnCrossSet() {
		String crossNames = SystemCfg.getWarnCross(CrossListActivity.this);
