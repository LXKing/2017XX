...
//		sqliteDatabase.execSQL("delete from warndata where julianday(datetime('now', 'localtime'))- julianday(datetime(datetime))>?", new Object[] { day });
//		sqliteDatabase.execSQL("delete from warnack where julianday(datetime('now', 'localtime'))- julianday(datetime(datetime))>?", new Object[] { day });
//		sqliteDatabase.execSQL("delete from warnpic where julianday(datetime('now', 'localtime'))- julianday(datetime(datetime))>?", new Object[] { day });
	}
	...
	public void clearWarnData() {
		sqliteDatabase.execSQL("delete from warndata");
		sqliteDatabase.execSQL("delete from warnack");
		sqliteDatabase.execSQL("delete from warnpic");
	}
	...
	public void markPunishId(String id, String type) {
		ContentValues cv = new ContentValues();
		cv.put("isused", 1);
		sqliteDatabase.update("printid", cv, "id = ?", new String[] { id });
		cv.clear();
	}
