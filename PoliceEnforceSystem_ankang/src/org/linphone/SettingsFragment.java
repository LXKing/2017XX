...
import com.xiangxun.activity.setting.VideoSettingActivity;

/**
 * 网络电话参数设置Fragment
 * 
 * @package: org.linphone
 * @ClassName: SettingsFragment.java
 * @Description:
 * @author: HanGJ
 * @date: 2015-09-27 下午3:22:19
 */
public class SettingsFragment extends PreferencesListFragment implements LinphoneEchoCalibrationListener {
	...
	private void initSettings() {
		...
		findPreference(getString(R.string.pref_add_account_key)).setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				...
				VideoSettingActivity.instance().displayAccountSettings(nbAccounts);
				return true;
			}
		});
	}
	...
	private void initAccounts() {
		...
		for (int i = 0; i < nbAccounts; i++) {
			...
			account.setOnPreferenceClickListener(new OnPreferenceClickListener() {
				@Override
				public boolean onPreferenceClick(Preference preference) {
					VideoSettingActivity.instance().displayAccountSettings(accountId);
					return false;
				}
			});
	...
	private void setVideoPreferencesListener() {
		// findPreference(getString(R.string.pref_video_enable_key)).setOnPreferenceChangeListener(new
		...
		// findPreference(getString(R.string.pref_video_initiate_call_with_video_key)).setOnPreferenceChangeListener(new
		// OnPreferenceChangeListener() {
		// @Override
		// public boolean onPreferenceChange(Preference preference, Object
		// newValue) {
		...
		// findPreference(getString(R.string.pref_video_automatically_accept_video_key)).setOnPreferenceChangeListener(new
		// OnPreferenceChangeListener() {
		// @Override
		// public boolean onPreferenceChange(Preference preference, Object
		// newValue) {
	...
	public void onResume() {
		...
		if (MainTabActivity.isInstanciated()) {
			// MainTabActivity.instance().selectMenu(FragmentsAvailable.SETTINGS);
