...
//	}
	...
	public static int pixelsToDpi(Resources res, int pixels) {
		return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, pixels, res.getDisplayMetrics());
	}
	...
	public static void collectLogs(Context context, String email) {
    	...
    	try {
            ...
            if( zipLogs(sb, zipFilePath) ) {
            	final String appName = (context != null) ? context.getString(R.string.app_title) : "Linphone(?)";
