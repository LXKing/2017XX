...
public class DialerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		if (MainTabActivity.isInstanciated() && LinphoneManager.getLc().getCallsNb() > 0) {
		...
		addContactListener = new OnClickListener() {
			...
			public void onClick(View v) {
				//MainTabActivity.instance().displayContactsForEdition(mAddress.getText().toString());
			}
		};
		cancelListener = new OnClickListener() {
			@Override
			public void onClick(View v) {
				MainTabActivity.instance().resetClassicMenuLayoutAndGoBackToCallIfStillRunning();
			}
		};
		...
		mAddContact.setEnabled(!(MainTabActivity.isInstanciated() && LinphoneManager.getLc().getCallsNb() > 0));
	...
	public void onResume() {
		...
		if (MainTabActivity.isInstanciated()) {
			//MainTabActivity.instance().selectMenu(FragmentsAvailable.DIALER);
			//MainTabActivity.instance().updateDialerFragment(this);
//			MainTabActivity.instance().showStatusBar();
		}
